...
这是一个通过调用 API 或本地演示引擎实现会议纪要生成的 AI 提效工具，用于把会议转写文本整理成结构化纪要，并支持智能洞察、待办追踪、纪要追问和交付导出。项目采用多视图工作台设计，首页保持简洁，其它高级能力拆分到独立页面。
...
- 体验方案：使用左侧导航 + 多视图工作台，把总览、智能洞察、待办中心、追问助手和交付导出拆分展示，适合现场演示。
